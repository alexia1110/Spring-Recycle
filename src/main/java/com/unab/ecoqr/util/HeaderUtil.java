...
public final class HeaderUtil {
    ...
    public static HttpHeaders createAlertLong(String applicationName, String message, Long param) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("X-" + applicationName + "-alert", message);
        return headers;
    }
    ...
    public static HttpHeaders createEntityDeletionAlert(String applicationName, boolean enableTranslation, String entityName, String id) {
        String message = enableTranslation ? applicationName + "." + entityName + ".deleted"
            : "A " + entityName + " is deleted with identifier " + id;
        return createAlert(applicationName, message, id);
    }

    public static HttpHeaders createEntityDeletionAlertLong(String applicationName, boolean enableTranslation, String entityName, Long id) {
        String message = enableTranslation ? applicationName + "." + entityName + ".deleted"
            : "A " + entityName + " is deleted with identifier " + id;
        return createAlertLong(applicationName, message, id);
    }
    /**
